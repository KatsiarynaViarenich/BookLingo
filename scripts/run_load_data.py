...
def main():
    ...
    book_list = [
        ...
        Book(
            title="Aladdin",
            author="Ruth Hobart",
            path="../data/Aladdin-Ruth_Hobart.epub",
        ),
        Book(
        ...
        Book(
            title="Cinderella",
            author="Ruth Hobart",
            path="../data/Cinderella-Ruth_Hobart.epub",
        ),
        Book(
            title="Lord Arthur Saviles Crime",
            author="Oscar Wilde",
        ...
        Book(
            title="Marley and Me",
            author="John Grogan",
            path="../data/Marley_and_Me-John_Grogan.epub",
        ),
        Book(
        ...
        Book(
            ...
            author="O Henry",
            path="../data/One_Thousand_Dollars-O_Henry.epub",
        ),
        Book(
            title="Peter Pan",
            author="J. M. Barrie",
            path="../data/Peter_Pan-J_M_Barrie.epub",
        ),
        Book(
        ...
        Book(
            ...
            author="Conan Doyle",
            path="../data/The_Yellow_Face-Conan_Doyle.epub",
        ),
        Book(
        ...
        Book(
            title="What Happened at Seacliffe",
            author="Denise Kirby",
        ...
        Book(
            ...
            path="../data/Zorro-Sally_M_Stockton.epub",
        ),
    ]
